...
def static_handler(path):
    return static_file(path, root=os.path.dirname(os.path.abspath(__file__)) + '/resource/static/')

@route('/')
def index():
    return static_file('resource/index.html', root=os.path.dirname(__file__))
...
def serve(path):
    ...
    print('Found', len(file_lst), 'images')
